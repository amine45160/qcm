...
public interface QcmServiceInterface extends Remote {
    ...
    public List<Thematique> getNotLaunchedThematiques(List<Thematique> l1 , List<Thematique> l2)throws RemoteException;

    public List<Thematique> getAllThematiques(int level)throws RemoteException;

    public List<Question> getQCMbyTheme (int theme)throws RemoteException;
    ...
    public List<Thematique> getMyThemes(int level) throws RemoteException;
