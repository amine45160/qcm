          ...
          <div class="row">
              ...
              <s:iterator value="listOfThematic" var="item">
                  <div class="col-lg-4">
                      ...
                      <p><button name="" id=""  type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Afficher Questions </button></p>
                  </div>
              </s:iterator>
          </div>
                      ...
                      <div class="modal-body">
                          <form>
                              <div class="form-group">
                                  <s:iterator value="listQuestion" var="ques">
                                  <h4><s:property value="%{#ques.contenuQuestion}"/></h4>
                                  </s:iterator>
